import 'bloc/suceess_one_bloc.dart';
import 'dart:async';
import 'models/suceess_one_model.dart';
...
class SuceessOneScreen extends StatelessWidget {
  SuceessOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SuceessOneBloc>(
      create: (context) => SuceessOneBloc(SuceessOneState(
        suceessOneModelObj: SuceessOneModel(),
      ))
        ..add(SuceessOneInitialEvent()),
      child: SuceessOneScreen(),
    );
  }
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    BlocSelector<SuceessOneBloc, SuceessOneState,
